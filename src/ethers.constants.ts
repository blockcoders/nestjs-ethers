...
export const ARBITRUM_SEPOLIA_NETWORK: Network = {
  chainId: 421614,
...
export const NETWORKS_BY_CHAIN_ID: Record<number, Network> = {
  ...
  [ARBITRUM_GOERLI_NETWORK.chainId]: ARBITRUM_GOERLI_NETWORK,
  [ARBITRUM_SEPOLIA_NETWORK.chainId]: ARBITRUM_SEPOLIA_NETWORK,
...
export const NETWORKS_BY_NAME: Record<string, Network> = {
  ...
  [ARBITRUM_GOERLI_NETWORK.name]: ARBITRUM_GOERLI_NETWORK,
  [ARBITRUM_SEPOLIA_NETWORK.name]: ARBITRUM_SEPOLIA_NETWORK,
